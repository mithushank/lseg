...
public: 
    ...
    string ord_id;             // conert OrderID to ord_id
    string cli_id;             // convert ClientOrderID to cli_id
    string name;               // convert instrument to name
    int side;
    double price;
    int qty;
    int rem_qty;
    ...
    void validation(string *,string *,string *,string *,string *);  // check whether an order is valid or not
    bool validate();                                           // check order status
...
int main(void) {
    ...
    return 1;
		...
		cout << "f in open successfully"<< endl;
	}
